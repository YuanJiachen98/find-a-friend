...
import {AppBar,Toolbar,Grid,Paper,Avatar,TextField,Button,Typography,Link} from '@material-ui/core';
					...
					<Grid item xs={9}>
						<Paper style={leftPaperStyle}>
							<div>
								...
								<img src="https://images.unsplash.com/photo-1490750967868-88aa4486c946?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=1950&q=80" alt="~~flowers" width="60%"/>
							</div>
						</Paper>
					</Grid>
					<Grid item> 
						<Paper style={rightPaperStyle} elevation={10}>
							...
							<form onSubmit = {this.handleSubmit}>
								...
								<TextField label="Last name" placeholder="Yuan" name="lastname" id="lastname" fullWidth required onChange={this.handleChange} value={this.state.lastname}/>	
							...
							<Typography>
								Already have an account?<Link herf=" " onClick={this.redirectToLogIn}>Log in</Link>
